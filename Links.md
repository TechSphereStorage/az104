...
We've also created a real-life Peering and NSG lab for you where we teach you how to implement a lab environment that will reflect the topology of a company’s on-premises networks and verify its functionality. Click on the PDF below to start the lab with your own Azure account.
